...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA7     ------> ADC1_IN7
    */
    HAL_GPIO_DeInit(GPIOA, M0_Cur_Sense_Pin|M1_Cur_Sense_Pin|M2_Cur_Sense_Pin|M3_Cur_Sense_Pin
                          |M4_Cur_Sense_Pin);
...
void HAL_TIM_PWM_MspInit(TIM_HandleTypeDef* htim_pwm)
{
  ...
  /* USER CODE END TIM1_MspInit 0 */
    ...
    PA9     ------> TIM1_CH2
    */
    GPIO_InitStruct.Pin = M0_A_Pin|M0_B_Pin;
...
void HAL_TIM_PWM_MspDeInit(TIM_HandleTypeDef* htim_pwm)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PA10     ------> TIM1_CH3
    */
    HAL_GPIO_DeInit(GPIOA, M0_A_Pin|M0_B_Pin|M0_PWM_Pin);
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PB3     ------> TIM2_CH2
    */
    HAL_GPIO_DeInit(GPIOB, M1_PWM_Pin|M1_B_Pin);

    HAL_GPIO_DeInit(M1_A_GPIO_Port, M1_A_Pin);
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PC7     ------> TIM3_CH2
    */
    HAL_GPIO_DeInit(M2_PWM_GPIO_Port, M2_PWM_Pin);

    HAL_GPIO_DeInit(GPIOC, M2_A_Pin|M2_B_Pin);
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PB8     ------> TIM4_CH3
    */
    HAL_GPIO_DeInit(GPIOB, M3_A_Pin|M3_B_Pin|M3_PWM_Pin);
  ...
  /* USER CODE END TIM5_MspDeInit 0 */
    ...
    PA2     ------> TIM5_CH3
    */
    HAL_GPIO_DeInit(GPIOA, M4_A_Pin|M4_B_Pin|M4_PWM_Pin);
